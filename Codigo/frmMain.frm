...
Begin VB.Form frmMain 
   ...
   Begin VB.Timer AutoSave 
      ...
      Top             =   0
   End
   Begin VB.CommandButton cmdActuUsu 
      Caption         =   "Actualizar"
      Height          =   255
      Left            =   1320
      TabIndex        =   7
   ...
   Begin VB.ListBox lstusuarios 
      Columns         =   2
      Height          =   900
      ItemData        =   "frmMain.frx":E8FF
      Left            =   120
      List            =   "frmMain.frx":E901
      TabIndex        =   6
      Top             =   2660
      Width           =   4935
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command5 
         Caption         =   "Enviar por Consola a GM's"
         Height          =   255
         Left            =   120
         TabIndex        =   13
         Top             =   840
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "Enviar por Consola a TODOS"
         Height          =   255
         Left            =   120
         TabIndex        =   15
         Top             =   600
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Modificado el 17 de Agosto del 2004 - Por ^[GS]^"
      Height          =   255
      Left            =   120
      TabIndex        =   9
      Tag             =   "v 0.10b"
   ...
   Begin VB.Menu mnuControles 
      ...
      End
      Begin VB.Menu apagarcorrecto 
         Caption         =   "&Apagar correctamente Servidor"
      End
      Begin VB.Menu lin2 
         Caption         =   "-"
      End
...
Private TelBuffer As String, TelAutenticado As Integer ' Hiper-AO no esta ?¡?
...
' [GS]
Private Sub ApagarCorrecto_Click()
DoEvents
...
Private Sub BarraEstado_PanelClick(ByVal Panel As ComctlLib.Panel)

End Sub

' [OLD]
Private Sub cmdActuUsu_Click()
Dim h As Long
lstusuarios.Clear
For h = 1 To LastUser
    If UserList(h).Name <> "" Then lstusuarios.AddItem UserList(h).Name
Next h
End Sub
' [/OLD]
