...
Public Function setNOTIFYICONDATA(hWnd As Long, ID As Long, flags As Long, CallbackMessage As Long, Icon As Long, Tip As String) As tNOTIFYICONDATA
    Dim nidTemp As tNOTIFYICONDATA
