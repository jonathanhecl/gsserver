...
Option Explicit
'Servidor zipao sin parche compatible con clientes 9.9z ;)

'Sicarul:
'Arreglados un monton de BUGS en el codigo y los dats.
'-Anti Speed Hack incorporado
'-Los muertos hablan, gritan y susurran
'-Objetos de la armada y el caos nuevos
'-Mensaje de lluvia que daba LAG quitado
'-Exp y oro Subidos directamente del codigo fuente
'-Ver la vida al hacer click
'-Algunos BUGS arreglados
'-Comandos: /Torneo, /Show Torneo, /orgtorneo #(1-2-3) y /fintorneo(borra la lista de los q hicieron /torneo)
'-Anti cheat para /Entrenar
'-Nuevo tipo de pocion(usado como Gema): De resureccion
